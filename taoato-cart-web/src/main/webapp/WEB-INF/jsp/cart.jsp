...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://localhost:9002"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://localhost:9002"  clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:9011/order/order-cart.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
                ...
                <div class="cart-empty">
                    <div class="message">
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost:9008/checkLogin" class="btn-1 login-btn mr10">登录</a>
                                <a href="http://localhost:9002" class="ftx-05">
                                    去购物&gt;
                                </a>
                            </li>
                        </ul>
...
<!-- 购物车相关业务 -->
<script type="text/javascript" src="/js/lib-v1.js"/>
...
<script type="text/javascript" >
    ...
    $(function () {
        ...
        var cookie = $.cookie('COOKIE_TOKEN_KEY');
