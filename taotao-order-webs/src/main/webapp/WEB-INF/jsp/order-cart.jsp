...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receivernobile" value="15891588888"/>
		<input type="hidden" name="orderShipping.receiverstate" value="四川省"/>
		<input type="hidden" name="orderShipping.receivercity" value="成都"/>
		<input type="hidden" name="orderShipping.receiverdistrict" value="金牛区"/>
		<input type="hidden" name="orderShipping.receiveraddress" value="树蓓街 xxxxxxxxx"/>
</form>
    ...
    <div class="goods-suit goods-last">
	 <c:forEach items="${cartList }" var="cart">
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="http://localhost:9002/item/${cart.id}.html">
					<img src="${cart.image}" alt="">
				</a>
			</div>
			<div class="goods-msg">
				<div class="p-name">
					<a href="http://localhost:9002/item/${cart.id}.html" target="_blank">
						${cart.title } 
					</a>
				</div>
				<div class="p-price">
